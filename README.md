...
# ![app icon](./.github/readme-images/app-icon.png)TachiyomiSK
Mihon is a free and open source manga reader for Android 6.0 and above. This version of Mihon, TachiyomiSK was based off TachiyomiSY. This version is meant to push forward in the ways of usability and features. TachiyomiSK tries to push forward where it can, but staying in a place where it can easily grab updates and features from the main app, it tries to make new features, or take features from other forks like J2K and Neko.
...
Features of TachiyomiSK include:
